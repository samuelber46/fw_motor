            ...
            <div class="car-body">
                <div class="row">
                    <div class="col-md-6 p-5 d-flex align-self-center">
                        <img src="{{ url('uploads') }}/{{ $motor->image }}" class="rounded mx-auto d-block" width="80%" alt="">
                    </div>
                    <div class="col-md-6 p-5">
                        ...
                        <form action="{{ url('order') }}/{{ $motor->id }}" method="post">
                            ...
                            <div class="container mt-5">
                                <div class="row">
                                    <div class="col-md-6">
                                        <button type="submit" class="btn btn-success d-inline-flex align-self-center"><i class="material-icons">shopping_cart</i> Add to cart</button>
                                    </div>
                                    <div class="col-md-6">
